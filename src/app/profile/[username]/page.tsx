...
export default async function ProfileDetailPage({ params }: { params: Promise<{ username: string }> }) {
  ...
  const currentUrl = `${baseUrl}/profile/${post.slug}`;
  ...
  return <ProfileDetailClient post={post} content={content} logoUrl={logoUrl} brandName={brandName} website={website} domain={domain} descriptionHtml={descriptionHtml} suggestedArticles={suggestedArticles} breadcrumbData={breadcrumbData} currentUrl={currentUrl} />;
}
